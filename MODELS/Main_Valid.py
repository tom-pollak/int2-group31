...
tensorboard = callbacks.TensorBoard(log_dir="logs/Main_Valid")
 
model.fit(train_generator, steps_per_epoch = steps_per_epoch, validation_data=(valid_images, valid_labels), epochs=400, callbacks=[tensorboard])

model.evaluate(test_images, test_labels)

model.save('saved_model/Main_Valid')
